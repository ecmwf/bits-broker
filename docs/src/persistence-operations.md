...
| `delete_job` fails at job completion | Error is silently ignored. The stale record remains in the store but is harmless, and the reading broker will see an active lease for the owning broker. |
